...
<div class="easyui-layout" fit="true" style="height: 250px;">
    <div region="center">
        <div id="content" class="easyui-tabs" border="false" fit="true">
            ...
            <div title="固定表头查询" data-options="iconCls:'icon-table'" style="overflow:auto;">
                <iframe scrolling="auto" frameborder="0" src="<%=request.getContextPath()%>/report/fix/query"
            ...
            <div title="帮助" data-options="iconCls:'icon-help'" style="overflow:auto;">
                <iframe scrolling="auto" frameborder="0" src="/assets/modules/report/help/EasyReportHelp.htm"
                        style="width: 100%; height: 100%;"></iframe>
            </div>
        </div>
    </div>
