...
/**
 * Created by Halo on 2017/11/28.
 */
@Service
public class ExcelToHtmlService {
    //TODO  delete
    public static void main(String[] args) {
        String originPath="C:\\Users\\Halo\\Desktop\\d3.xlsx";
        String destPath="C:\\Users\\Halo\\Desktop\\d3.html";
        ExcelToHtmlService.readExcelToHtml(originPath,destPath,true);
    }
    ...
    private static String getExcelInfo(Workbook wb,boolean isWithStyle){
        ...
        sb.append("</table>");
        System.out.println("originalData:"+sb.toString());
        return sb.toString();
    }
